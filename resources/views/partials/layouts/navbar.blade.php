                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                                    ...
                                    {{-- <div class="scroll-y mh-325px px-5">
                                        <div class="d-flex flex-stack py-4">
                                            <div class="d-flex align-items-center">
                                                <div class="mb-0 me-2">
                                                    <p class="fs-6 text-gray-800 text-hover-primary fw-bolder">Nama
                                                        pemohon</p>
                                                    <div class="text-gray-400 fs-7">Telah mengirimkan permohonan (nama
                                                        layanan)</div>
                                                </div>
                                            </div>
                                            <span class="badge badge-light fs-8">Waktu</span>
                                        </div>
                                        <a href=""> <span class="badge badge-primary fs-8">Tandai Telah di
                                                baca</span></a>
                                    </div>
                                    <hr> --}}
                                </div>
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                            ...
                            <img alt="Logo"
                                src="{{ Auth::user()->photo ? asset('assets/img/profile/' . Auth::user()->photo) : asset('assets/img/logo.jpg') }}" />
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-item px-5">
                                ...
                                <a href="javascript:void()" data-toggle="pill" data-bs-toggle="modal"
                                    data-bs-target="#logoutModal" class="menu-link px-5">Sign Out</a>
                            </div>
                            <!--end::Menu item-->
                        </div>
                        <!--end::Menu-->
